...
class AttnBiLSTM(nn.Module):
    def __init__(self, embedding_size, hidden_size, total_words, num_class, num_layers, fixed_embeds=None, pretrained = False, pretrained_embed = None):
        ...
        self.wordembed = nn.Embedding(total_words, embedding_size)
        self.lstm = nn.LSTM(embedding_size, hidden_size, num_layers = 3, bidirectional = True)
